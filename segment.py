...
#Change the path for opening the image

def input_image():
    from PIL import Image
    image=Image.open("C:/Users/Abhishek/Desktop/FlaskS/masked_image.png")
    image.show()
...
def segment():
    ...
    def display_instances(image, boxes, masks, class_ids, class_names,
        ...
        ax.figure.savefig("masked_image.png")
    ...
    CHANGE MODEL PATH AND LOAD IMAGE IN 'IMAGE' VARIABLE
    '''

    model_path = (STATIC_FOLDER + '/mask_rcnn_tumor_detector_0015.h5')
    ...
    image = skimage.io.imread(UPLOAD_FOLDER + '/test.jpg')
    # original image
...
def return_file():
	#path = "html2pdf.pdf"
	#path = "info.xlsx"
	path = "C:/Users/Abhishek/Desktop/FlaskS/masked_image.png"
	#path = "sample.txt"
